...
export default function Movie() {
  ...
  const getMovieInfo = async () => {
    try {
      setIsLoading(true)
      const response = await axios.get(`https://api.themoviedb.org/3/movie/${movieId}?language=en-US&api_key=68ddd5c2d68a3e3e8867e8c8a165e3bf`);
  ...
  return (<>
    {
      isLoading ? (<div className="max-w-[1200px] w-full py-5">
        <p className=" text-right">Rating</p>
        <div className="w-full flex justify-between">
          <div className="flex flex-col gap-2">
            <div className="w-[250px] bg-gray-300 h-[40px] dark:bg-gray-700 rounded-3xl"></div>
            <div className="w-[300px] bg-gray-300 h-[30px] dark:bg-gray-700 rounded-3xl"></div>
          </div>
          <div className="flex flex-col gap-2">
            <div className="w-[100px] bg-gray-300 h-[25px] dark:bg-gray-700 rounded-3xl"></div>
            <div className="w-[100px] bg-gray-300 h-[20px] dark:bg-gray-700 rounded-3xl"></div>
          </div>
        </div>
        <div className="flex gap-5 mt-5">
          <div className="w-[290px] bg-gray-300 h-[425px] rounded-md"></div>
          <div className="w-[760px] bg-gray-300 h-[425px] rounded-md"></div>
        </div>
        <MoviePages size={5} />
