...
export default function Movie() {
  ...
  return (
    <div className="flex flex-col items-center justify-center relative xl:max-w-[1200px]">
      <div className="flex flex-col items-center justify-center gap-5">
        ...
        <div className="w-full flex flex-col gap-8 p-5">
            ...
            <div className="relative w-[375px] lg:w-fit">
              ...
              <div className="w-full bg-black bg-opacity-50 h-full absolute top-0 p-5 lg:p-10 flex items-end">
                ...
                <div className="flex items-center gap-2 text-white">
                  <Button className="rounded-full w-fit h-fit p-3 flex items-center justify-center bg-white ">
          ...
          <div className="flex w-full gap-10">
            <img src={`https://image.tmdb.org/t/p/original${movie?.poster_path}`} className="w-[100px] h-[148px] rounded-md lg:hidden" />
